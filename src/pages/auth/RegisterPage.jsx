      ...
      <div className="auth-card">
        <div className="auth-brandline">
          <div className="auth-register-heading">
            ...
            <p className="auth-register-sub">Join CodeX Hub and get started today.</p>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            <div>
              ...
              <input
                placeholder="Jane"
                {...field("first_name", { required: "Required" })}
              />
              {errors.first_name && (
                <p
                  style={{
            ...
            <div>
              ...
              <input
                placeholder="Doe"
                {...field("last_name", { required: "Required" })}
              />
              {errors.last_name && (
                <p
                  style={{
          ...
          <button
            ...
            style={{
              ...
              background: loading
                ? "#93b8d8"
                : "linear-gradient(135deg, #4E89BD, #61AFEE)",
              color: "white",
              fontWeight: "700",
              fontSize: "16px",
              border: "none",
